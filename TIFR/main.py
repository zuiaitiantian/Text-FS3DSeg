...
if __name__ == '__main__':
    ...
    parser.add_argument('--S3DIS_emb_path',default='/hy-tmp/TIFR/dataloaders/s3dis_embeddings.npy')
    parser.add_argument('--ScanNet_emb_path',default='/hy-tmp/TIFR/dataloaders/scannet_embeddings.npy')
